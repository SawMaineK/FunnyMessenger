...
import com.smk.funnymessenger.clients.NetworkEngine;
...
public class FnMessengerConfigs {
    private static FnMessengerConfigs ourInstance;
    ...
    public static FnMessengerConfigs getInstance() {

        if(ourInstance != null)
            return ourInstance;
        else
            ourInstance = new FnMessengerConfigs();
        return ourInstance;
    }


    private FnMessengerConfigs() {
