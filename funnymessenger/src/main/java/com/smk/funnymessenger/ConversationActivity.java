package com.smk.funnymessenger;
...
import com.smk.funnymessenger.adapters.ConversationListAdapter;
import com.smk.funnymessenger.database.DatabaseManager;
import com.smk.funnymessenger.database.controller.MessageController;
import com.smk.funnymessenger.models.Message;
import com.smk.funnymessenger.models.User;
import com.smk.funnymessenger.services.ChatService;
import com.smk.funnymessenger.utils.StoreUtil;
        ...
        edt_message.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(s.length() > 0){
                    ...
                    btn_send.setColor(getResources().getColor(R.color.fnMessengerPrimaryColor));
                    ...
                    btn_send.setColor(getResources().getColor(R.color.fnMessengerGrey));
